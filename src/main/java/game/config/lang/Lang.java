...
public abstract class Lang implements Serializable {
    ...
    public static String err_artifact_cooldown = "err_artifact_cooldown"; // Đang hồi chiêu, không thể đổi hoặc sử dụng
    ...
    public static String msg_bonus_to_mail = "msg_bonus_to_mail"; // Phần thưởng đã được gửi vào thư!
